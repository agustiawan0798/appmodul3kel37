    ...
    public void getAllCar(){
        ...
        RetrofitClient.getInstance()
                ...
                .enqueue(new Callback<JsonObject>() {
                    @Override
                    public void onResponse(Call<JsonObject> call, Response<JsonObject> response) { //kalau kita terhubung ke server
                    ...
                    @Override
                    public void onFailure(Call<JsonObject> call, Throwable t) { //kalau responnya gagal
                        homeView.failedShowCar("Maaf terjadi kesalahan");
